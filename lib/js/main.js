...
class Wizard {
  ...
  send() {
    ...
    let ajaxurl = "http://localhost:8888/wp-admin/admin-ajax.php";
    jQuery.post(ajaxurl, data)
      .done(function(self) {
        return function() { self.mode(1); };
      }(this))
      .fail(function(self) {
        return function() { self.mode(2); };
      }(this))
      .always(function() { jQuery(window).scrollTop(0); });
  }
  readablePrice(price) {
    return price + ' CHF';
  }
